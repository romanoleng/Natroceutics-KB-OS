      ...
      <header className="os-header">
        <div className="os-header-inner">
          ...
          <div className="os-header-actions">
            ...
            {/* Tracking indicator lives in the header beside Settings rather
                than floating over the page: it belongs with the other status
                and account controls, not on top of the content. */}
            <TimeTracker />
