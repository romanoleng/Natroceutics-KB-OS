...
const PENDING = [
  { key: 'outlook', label: 'Outlook', region: 'UK', detail: 'Daily inbox triage into tasks' },
  { key: 'granola', label: 'Granola', region: 'All', detail: 'Meeting notes, decisions and actions' },
];
