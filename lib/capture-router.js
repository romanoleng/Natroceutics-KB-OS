 ...
 */
/**
 * Keys are the CANONICAL Business Area names from lib/business-areas.js, not a
 * private vocabulary. This router used to emit B2B / ORDERS / STOCK while the
 * daily Outlook agent wrote Amazon / Shopify / Warehouse into the same field,
 * which is half of how that column reached 21 values for 12 concepts.
 *
 * RISKS is not a business area — it changes which TABLE is used — so it is
 * detected here and stripped out before the area is set.
 */
const SECTIONS = [
  { key: 'B2B', words: ['b2b', 'wholesale', 'trade account', 'practitioner'] },
  { key: 'RISKS', words: ['risk', 'blocker', 'blocked', 'issue', 'problem'] },
  { key: 'Amazon UK', words: ['amazon', 'fba', 'asin', 'seller central', 'sellerboard', 'transparency'] },
  { key: 'Shopify UK', words: ['shopify', 'order', 'orders', 'checkout'] },
  { key: 'Warehouse', words: ['stock', 'soh', 'inventory', 'warehouse', 'bio-nature', 'bionature'] },
  { key: 'Packaging', words: ['packaging', 'label', 'labels', 'carton'] },
  { key: 'Subscriptions', words: ['subscription', 'subscriber', 'recharge'] },
  { key: 'Affiliates', words: ['affiliate', 'affiliates', 'goaffpro'] },
  { key: 'Customer Experience', words: ['complaint', 'customer service', 'support ticket', 'customer', 'customers'] },
  { key: 'Marketing', words: ['marketing', 'campaign', 'klaviyo', 'mailer', 'email list'] },
  { key: 'Finance', words: ['invoice', 'billing', 'bill', 'fee', 'vat', 'payout'] },
  { key: 'Events', words: ['webinar', 'symposium', 'cpd', 'meeting', 'call with', 'granola'] },
];
