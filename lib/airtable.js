...
async function fetchFromRegion(baseEnvVar, tableId, sortField) {
  ...
  return fetchAll(tableId, sortField, getRegionBase(baseEnvVar), baseId);
}
...
export async function getUKAmazonDailyPnL()     { return fetchFromRegion('AIRTABLE_UK_BASE_ID', UK_TABLES.AMAZON_DAILY_PNL, 'Date'); }
export async function getUKAmazonAsinDaily()    { return fetchFromRegion('AIRTABLE_UK_BASE_ID', UK_TABLES.AMAZON_ASIN_DAILY, 'Date'); }
export async function getUKAmazonOrders()       { return fetchFromRegion('AIRTABLE_UK_BASE_ID', UK_TABLES.AMAZON_ORDERS, 'Order ID'); }
...
export async function getUKPPC()                    { return fetchFromRegion('AIRTABLE_UK_BASE_ID', UK_TABLES.PPC, 'Campaign Name'); }
export async function getUKAmazonDisbursements()    { return fetchFromRegion('AIRTABLE_UK_BASE_ID', UK_TABLES.AMAZON_DISBURSEMENTS); }
...
/* ── UK — NEW EXPORTS ────────────────────────────────────── */
export async function getUKAmazonReviews()  { return fetchFromRegion('AIRTABLE_UK_BASE_ID', UK_TABLES.REVIEWS, 'Review Date'); }
...
export async function getUKSalesByProduct() { return fetchFromRegion('AIRTABLE_UK_BASE_ID', UK_TABLES.SALES_BY_PRODUCT, 'SKU'); }
...
export async function getAffiliateSales()    { return fetchFromRegion('AIRTABLE_AFFILIATE_BASE_ID', AFF_TABLES.SALES); }
export async function getAffiliatePayouts()  { return fetchFromRegion('AIRTABLE_AFFILIATE_BASE_ID', AFF_TABLES.PAYOUTS); }
export async function getAffiliateTraffic()  { return fetchFromRegion('AIRTABLE_AFFILIATE_BASE_ID', AFF_TABLES.TRAFFIC, 'Affiliate Name'); }
